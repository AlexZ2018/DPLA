...
Answering questions: 4, 9, 11, 12, 15
'''
import sys
import dpla_utils
...
def collection_supplementary():
	...
	parser.add_argument('-i', action='append', dest = 'collection_input_file', help = 'A collection file generated by set_collection_list.py is needed')
	results = parser.parse_args()

	collection_input_csv = results.collection_input_file[0]
	...
	try:
		with open(collection_input_csv, 'r') as input_file:
